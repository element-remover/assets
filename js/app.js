      ...
      if (cv || cw) {
        ...
        if (cw) {
          ...
          res.webs.map(site => $('#dr').appendChild(create("div", 'fx',
            `<div class='fy'><img data-src="https://element-remover.github.io/assets/static/svg/mui.svg" src="https://${site.img}" alt="${site.info}"></div><a href="https://${site.link}/?ref=element-remover-${app.su}&svr=${svr}&id=${site.id}" target="_blank"` +
